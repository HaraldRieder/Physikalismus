...
\sum_{jkl}\ \leftidx{^\mathrm{Q}}\psi_{\lambda_j}^{(0)}\ 
...
Damit kann die neue Dynamik die Wahrscheinlichkeiten für Ereignisse inklusive Quanten-Zeno-Effekt liefern. Es bleibt noch, diese Dynamik im Sinne der Dekohärenztheorie zu formulieren, also die richtigen Amplituden herzustellen unter Berücksichtigung einer Verschränkung mit der Umgebung.
