...
Wir versuchen es mit folgender einfache Definition:

\textbf{Bedeutung} ist die Änderung, die der Empfang einer Nachricht in einem bestimmten Empfänger auslöst. 

Diese Definition passt zur Alltagsvorstellung der Nachrichtenübertragung gemäß \eqref{eq:messaging_classical}. Obwohl wir nicht bei dieser Definition bleiben werden, liefert sie uns ein sehr wichtiges Ergebnis: \textbf{eine Nachricht enthält niemals Bedeutung}, denn ohne Empfänger gibt es keine Bedeutung. So hat auch diese Schrift keine Bedeutung, ohne das sie jemand liest.
...
\textbf{Bedeutung} ist die Verschränkung, die sich zwischen Nachricht und Empfänger aufbaut. 

...TODO Kritik wie oben subjektiv. Vertagen auf Prozess1 QM...


So lange eine Änderung niemandem bewusst wird, so lange muss sie nicht existieren. Bis zur Bewusstwerdung wird es immer eine Glaubensfrage bleiben, ob sich im physikalischen Kanal etwas verändert hat oder nicht. 



Im engeren Sinn ist eine Bedeutung die Empfindungen, die im Bewusstsein „des Empfängers“, oder anders ausgedrückt im abgeteilten Bewusstsein wahrgenommen werden, also der bewusstwerdende Teil der Veränderung. Die Bedeutung ensteht immer im Empfänger. Eine Nachricht hat keine Bedeutung.
