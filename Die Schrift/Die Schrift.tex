...
\end{equation}
Im Gegensatz zu unserer Definition von Ljapunow-Exponenten haben wir hier nur eine für $\psi$ als $1\cdot$ Matrix, doch das soll uns im weiteren Verlauf genügen.

Für chaotisches Verhalten gilt nun
\begin{equation} 
\lim_{\tau \to \infty} C_{{\psi\psi}}(\tau ) = 0
\end{equation}
d.h. die Funktion hat mit zunehmender Zeitdistanz "nichts mehr mit sich selbst zu tun".
