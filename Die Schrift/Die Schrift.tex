...
Es ist wichtig, dass du diese erste Erkenntnis verstehst und verinnerlichst. Sie ist der allererste Schritt zu weiterer philosophischer Erkenntnis. Arthur Schopenhauer beginnt das 1. Buch seines Hauptwerks \emph{Die Welt als Wille und Vorstellung} hiermit: 
...
\textit{Bedeutung} ist die Änderung, die der Empfang einer Nachricht in einem bestimmten Empfänger auslöst. 
...
\textbf{\textit{Bedeutung} ist die Verschränkung, die sich zwischen Nachricht und Empfänger aufbaut, und zwar bei der Zweiteilung ihres gemeinsamen Produktraums unter der Sicht, unter der sie anfangs entschränkt erschienen.}
...
„Gut“ und „schlecht“ sind eine reine Erfindung der Menschen. Ein Mensch, der funktioniert, wie die Natur ihn sich „gedacht“ hat, definiert „gut“ und „schlecht“ genau so: gut ist, was ich will, schlecht ist, was ich nicht will. Mehr steckt nicht dahinter. Ein Mensch, der beides anders definiert als so, bekommt sofort ein Problem mit seinem Willen. Er trägt in sich einen Widerspruch.

Treffen Abgeteilte aufeinander, so verursachen ihre Willen Konflikte. Organisieren sie sich zu höheren Formen, zu Familien, Stämmen, Staaten, so entwickeln die höheren Formen Gesamtwillen und Gesamtvorstellungen von „gut“ und „schlecht“. Die Beobachtung einer konstanten Gesamtwillensäußerung kann andersherum gesehen die Begriffsdefinition für eine höhere Form nahelegen. Ein Gesamtwillen steht in Konflikt mit den Willen der Abgeteilten oder anderen Gesamtwillen. Das Unterordnen unter einen Gesamtwillen beschert dem Abgeteilten einen Widerspruch. Ähnlich wie der Mensch sich einer höheren Form einordnet ordnen sich andere einfachere Formen in höhere ein: Ameisen in Staaten, Organe in Organismen, Organellen in Zellen. So ist das Ringen der Willen nichts anderes als das Ringen der Naturkräfte um die Gestaltung der Materie in höherer Ordnung.
...
\chapter{Die Struktur der Quantenmechanik}
