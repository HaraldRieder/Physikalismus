...
Richtig schwierig ist es, eine vernünftige Definition für den Begriff "Information" zu finden. Auch Wikipedia redet sich im Jahr 2019 hinaus unter Verwendung von Begriffen wie "Wissen", "Signal" und "Code", wodurch nichts erklärt wird. 
...
Ein fundamentales Konzept unserer Welt ist philosophisch natürlich höchst wichtig und man sollte für den entsprechenden Begriff eine klare Vorstellung entwickeln.
...
In der Vorstellungswelt der klassischen Physik erzeugt ein Sender eine Nachricht dadurch dass er ein Stück Materie oder Energie formt, und der Empfänger empfängt dieses Stück Energiematerie.
...
I = \log_2 N 
\end{equation}
und wird in der Einheit \textit{Bit} gemessen.

Beispiel: Wenn nur die Auswahl einer einzigen Farbe aus den Farben {rot, grün, gelb, blau} möglich ist, hat man 4 Alternativen. Um eine Mitteilung über die ausgewählte Farbe zu kodieren sind 2 Bit notwendig. Die Information I ist allgemein eine positive reelle Zahl, die Anzahl der Alternativen muss keine Zweierpotenz sein.

Trifft eine Nachricht auf einen ganz simplen Emfänger, der nur 2 Zustände einnehmen kann, so kann ihr Informationsgehalt dennoch höher sein als $\log_2 2 = 1$. Der ganze Informationsgehalt zeigt sich erst in Empfängern, die genügend komplex sind und schlau genug an die Nachricht koppeln.

Wir haben postuliert, dass es möglich sein soll, Teile der Welt abzuspalten, die abzählbar endlich viele Bits enthalten. \textit{Das steht in krassem Widerspruch zur Vorstellung von kontiunierlichen Empfindungen!} Jede kontinuierliche Variable kann \textit{unendlich} viel Information aufnehmen. 
