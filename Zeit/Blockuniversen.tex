...
\end{equation}
$\left|\psi^{(0)}_{\lambda_j}\right|^2$ ist nichts anderes als die Übergangswahrscheinlichkeit 
\begin{equation} 
p^{(0)\rightarrow(1)} 
