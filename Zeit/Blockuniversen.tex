...
\begin{equation} 
\ket{x} \otimes \ket{t} = \sum_z V_{xt\, z}\ \ket{z} \quad\quad
\ket{z} = \sum_{xt} V^*_{z\, xt}\ \ket{x} \otimes \ket{t}
\end{equation}
\begin{equation} 
p^{(0)\rightarrow(z)} =\ \Bigl| \bra{z} \hat{V} \left(\ket{x}\otimes\ket{t_0}\right)\Bigl|^2
= \Bigl|\sum_{x'xt} \psi^{(0)*}_{x'} \bra{x'} \otimes \bra{t_0} V^*_{z\, xt}\ \ket{x} \otimes \ket{t}\Bigl|^2 
\end{equation}
\begin{equation} 
p^{(0)\rightarrow(z)} =\ \Bigl|\sum_{x} \psi^{(0)}_{x} V_{z\, xt_0}\ \Bigl|^2 
\end{equation}
analog
\begin{equation} 
p^{(z)\rightarrow(1)} =\ \Bigl|\sum_{x} \psi^{(1)}_{x} V_{z\, xt_1}\ \Bigl|^2 
\end{equation}
Gesamtübergangswahrscheinlichkeit
\begin{equation} 
p^{(0)\rightarrow(1)} =\ \sum_z\ p^{(0)\rightarrow(z)}\ p^{(z)\rightarrow(1)}
= \ \sum_{z}\ \Bigl(\ \Bigl|\sum_{x} \psi^{(1)}_{x} V_{z\, xt_1}\ \Bigl|^2\ \Bigl|\sum_{x} \psi^{(0)}_{x} V_{z\, xt_0}\ \Bigl|^2\ \Bigr)
\end{equation}
\begin{equation} 
p^{(0)\rightarrow(1)} 
= \ \sum_{z}\ \Bigl|\sum_{x'x} \psi^{(1)}_{x'} V_{z\, x't_1}\ V_{z\, xt_0}\ \psi^{(0)}_{x} \Bigl|^2  
\end{equation}
...
\ =\ \sum_{z}\ \Bigl|\sum_{x'x} \psi^{(1)}_{x'} v_{z\, x'}\ w_{z\, x}\ \psi^{(0)}_{x} \Bigl|^2 \quad
}
\end{equation}
